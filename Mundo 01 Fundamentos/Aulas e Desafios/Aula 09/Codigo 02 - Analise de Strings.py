...
print(frase.count('o')) # Exibe a quantidade de vezes que o caractere entre parênteses (no caso, "o" minúsculo) aparece na string (no caso, 3)
print(frase.count('o', 0, 13)) # Idem ao caso acima, porém aqui foi incluído um fatiamento do índice [0] ao [13]-1, exibindo "1"
